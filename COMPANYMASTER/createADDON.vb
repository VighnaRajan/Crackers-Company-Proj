...
Public Class createADDON
    ...
    Private Sub createADDON_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        writer.Close()
        writer.Dispose()
    End Sub
    Private Sub createADDON_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        con.ConnectionString = cs '"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & cs
        con.Open()
        rawcmd.CommandText = "select * from items where ucase(itemtype)='ADD-ON' and concerncode=" & ccode
    ...
    Private Sub addnew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles addnew.Click
        ...
        Else
            ...
            If ff = MsgBoxResult.Ok Then
                dupcmd.CommandText = "select * from items where ucase(itemcode)='" & UCase(itemcode.Text) & "' and concerncode=" & ccode & " and itemtype='ADD-ON'"
                dupds.Reset()
                dupds.Clear()
                ...
                If dupds.Tables(0).Rows.Count > 0 Then
                    ...
                    itemcode.Focus()
                Else
                    nucmd.CommandText = "insert into items values(" & ccode & ",'" & itemcode.Text & "','" & itemname.Text & "','ADD-ON','" & m(1) & "','" & m(2) & "')"
...
out:
    ...
    Private Sub editt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles editt.Click
        ...
        Else
            ...
            If ff = MsgBoxResult.Ok Then
                nucmd.CommandText = "update items set itemname='" & itemname.Text & "',measure='" & m(1) & "',measure1='" & m(2) & "' where itemcode='" & itemcode.Text & "' and concerncode=" & ccode & " and itemtype='ADD-ON'"
                writer.WriteLine("Query : " & nucmd.CommandText)
                nucmd.ExecuteNonQuery()
